...
recipes.addShaped(<contenttweaker:knowledge_rune>, [[null, <dungeontactics:magic_powder>, null],[<contenttweaker:sol_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:air_rune>.anyDamage().transformDamage()], [null, <wards:enchanted_paper>, null]]);
...
//mystical
recipes.addShaped(<contenttweaker:draconic_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:strength_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:knowledge_rune>.anyDamage().transformDamage()], [<bountifulbaubles:brokenblackdragonscale>, <iceandfire:dragonbone>, <rats:dragon_wing>]]);
recipes.addShaped(<contenttweaker:aether_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:mind_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:balance_rune>.anyDamage().transformDamage()], [<aether_legacy:ambrosium_shard>, <aether_legacy:zanite_gemstone>, <aether_legacy:aercloud>]]);
recipes.addShaped(<contenttweaker:holding_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:illusion_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:order_rune>.anyDamage().transformDamage()], [<endreborn:item_shard_obsidian>, <minecraft:ender_pearl>, <arcanearchives:shaped_quartz>]]);
recipes.addShaped(<endreborn:item_end_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:creation_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:life_rune>.anyDamage().transformDamage()], [<endreborn:item_end_essence>, <endreborn:item_ingot_endorium>, <minecraft:ender_eye>]]);
recipes.addShaped(<contenttweaker:nether_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:soul_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:disint_rune>.anyDamage().transformDamage()], [<minecraft:ghast_tear>, <minecraft:blaze_powder>, <betternether:cincinnasite>]]);
recipes.addShaped(<contenttweaker:plague_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:death_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:poison_rune>.anyDamage().transformDamage()], [<rats:herb_bundle>, <rats:plague_leech>, <minecraft:poisonous_potato>]]);
recipes.addShaped(<contenttweaker:arcane_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:chaos_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:energy_rune>.anyDamage().transformDamage()], [<biomesoplenty:sapling_0:3>, <simpleores:mythril_ingot>, <arcanearchives:radiant_dust>]]);
recipes.addShaped(<contenttweaker:fae_rune>, [[<dungeontactics:magic_powder>, <bountifulbaubles:spectralsilt>, <dungeontactics:magic_powder>],[<contenttweaker:nature_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:trans_rune>.anyDamage().transformDamage()], [<minecraft:red_mushroom>, <iceandfire:pixie_dust>, <minecraft:brown_mushroom>]]);
