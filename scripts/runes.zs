...
recipes.addShaped(<contenttweaker:nature_rune>, [[null, <dungeontactics:magic_powder>, null],[<contenttweaker:luna_rune>.anyDamage().transformDamage(), <contenttweaker:blank_rune>, <contenttweaker:earth_rune>.anyDamage().transformDamage()], [null, <ore:grass>, null]]);
