...
Saw.remove(MiniBlocks.getMiniBlock("corner", <ore:plankWood>));
Saw.add(MiniBlocks.getMiniBlock("corner", <ore:plankWood>),[<pyrotech:rock:7>*2,<minecraft:stick>.weight(0.4)]);
