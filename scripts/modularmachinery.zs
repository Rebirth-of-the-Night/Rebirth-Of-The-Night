...
val PowerHammmerItemOutputs = [
    ...
    <ore:dustSilver>.firstItem,
    <ore:dustSilver>.firstItem,  
    <ore:dustGravitite>.firstItem, 
    <ore:dustGravitite>.firstItem, 
    <ore:dustGravitite>.firstItem, 
    <ore:dustElectrum>.firstItem, 
    <ore:dustCrucibleSteel>.firstItem, 
    <ore:dustViridium>.firstItem, 
    <ore:dustViridium>.firstItem, 
    <ore:dustViridium>.firstItem, 
    <ore:dustMythril>.firstItem, 
    <ore:dustMythril>.firstItem, 
    <ore:dustMythril>.firstItem, 
    <ore:dustSoulforgedSteel>.firstItem, 
    <ore:dustEndorium>.firstItem, 
    <ore:dustAmbrosium>.firstItem, 
    <ore:dustAmbrosium>.firstItem, 
    <nyx:meteor_dust>, 
    <minecraft:coal:1>*6, 
...
for i, input in PowerHammerItemInputs {
    var powerhammerrecipe1 = RecipeBuilder.newBuilder(PowerHammmerRecipeNames[i], "powerhammer", PowerHammmerNumModifier[i]*40);
    powerhammerrecipe1.addItemInput(PowerHammmerItemInputs[i]);
    powerhammerrecipe1.addFluidInput(<liquid:unstable_soulfire>*PowerHammmerNumModifier[i]*40);
    powerhammerrecipe1.addItemOutput(PowerHammmerItemOutputs[i]);
