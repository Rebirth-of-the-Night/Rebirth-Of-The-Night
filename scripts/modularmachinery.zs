...
val DryerInputs = [<pyrotech:material:12>, <minecraft:sponge:1>, <pyrotech:material:25>, <harvestcraft:vanillabeanitem>, <harvestcraft:juteitem>, <betterwithaddons:wet_soap>] as IItemStack[];
...
for i, input in DryerInputs {
    ...
    dryerrecipe1.addItemInput(DryerInputs[i]);
...
recipes.addShaped(<modularmachinery:blockoutputbus:2>, [[null, null, null],[<ore:ingotBronze>, <modularmachinery:blockoutputbus:1>, <ore:ingotBronze>], [null, <minecraft:chest>, null]]);
recipes.addShaped(<modularmachinery:blockoutputbus:1>, [[null, null, null],[<ore:ingotBronze>, <modularmachinery:blockoutputbus>, <ore:ingotBronze>], [null, <minecraft:chest>, null]]);
recipes.addShaped(<modularmachinery:blockoutputbus>, [[null, <quark:chute>, null],[<ore:ingotBronze>, <minecraft:chest>, <ore:ingotBronze>], [null, <inspirations:pipe>, null]]);
recipes.addShaped(<modularmachinery:blockinputbus:2>, [[null, null, null],[<ore:ingotBronze>, <modularmachinery:blockinputbus:1>, <ore:ingotBronze>], [null, <minecraft:chest>, null]]);
recipes.addShaped(<modularmachinery:blockinputbus:1>, [[null, null, null],[<ore:ingotBronze>, <modularmachinery:blockinputbus>, <ore:ingotBronze>], [null, <minecraft:chest>, null]]);
recipes.addShaped(<modularmachinery:blockinputbus>, [[null, <inspirations:pipe>, null],[<ore:ingotBronze>, <minecraft:chest>, <ore:ingotBronze>], [null, <quark:chute>, null]]);
recipes.addShaped(<modularmachinery:itemblueprint>, [[null, <minecraft:iron_bars>, null],[<minecraft:stonebrick>, <minecraft:writable_book>, <contenttweaker:oak_boards>], [null, <pyrotech:drying_rack:1>, null]]);
