...
<atop:peridot_sword>.addTooltip(format.darkGreen("+15% Dig Speed"));
...
<atop:peridot_pickaxe>.addTooltip(format.darkGreen("+15% Dig Speed"));
...
<atop:peridot_axe>.addTooltip(format.darkGreen("+15% Dig Speed"));
...
<atop:peridot_shovel>.addTooltip(format.darkGreen("+15% Dig Speed"));
...
<atop:peridot_hoe>.addTooltip(format.darkGreen("+15% Dig Speed"));
