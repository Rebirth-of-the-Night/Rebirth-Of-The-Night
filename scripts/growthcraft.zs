...
// Grapes to grape seeds recipes
recipes.addShapeless("purple_grape_seed",<growthcraft_grapes:grape_seed:10>,[<growthcraft_grapes:grape:10>]);

recipes.addShapeless("green_grape_seed",<growthcraft_grapes:grape_seed:13>,[<growthcraft_grapes:grape:13>]);

recipes.addShapeless("red_grape_seed",<growthcraft_grapes:grape_seed:14>,[<growthcraft_grapes:grape:14>]);