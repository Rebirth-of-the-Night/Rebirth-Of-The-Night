...
recipes.addShapeless("standard dye 18",<minecraft:dye:12>,[<ore:toolMortarandpestle>,<biomesoplenty:double_plant:0>]);
...
recipes.addShapeless("standard dye 28",<biomesoplenty:brown_dye>,[<ore:toolMortarandpestle>,<biomesoplenty:double_plant:1>]);
...
mods.betterwithmods.Mill.addRecipe([<biomesoplenty:double_plant:0>],[<minecraft:dye:12>*2]);
...
mods.betterwithmods.Mill.addRecipe([<biomesoplenty:double_plant:1>],[<biomesoplenty:brown_dye>*2]);
...
mods.betterwithmods.Mill.addRecipe([<minecraftfuture:flowerblack>],[<biomesoplenty:black_dye>*2]);
