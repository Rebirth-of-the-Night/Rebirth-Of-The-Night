<harvestcraft:stockitem>.foodValues.hunger = 1;
<harvestcraft:stockitem>.foodValues.saturationModifier = 0.2;
<harvestcraft:beefwellingtonitem>.foodValues.hunger = 6;
<harvestcraft:beefwellingtonitem>.foodValues.saturationModifier = 0.35;
<harvestcraft:spidereyepieitem>.foodValues.hunger = 9.5;
<harvestcraft:spidereyepieitem>.foodValues.saturationModifier = 0.7;
