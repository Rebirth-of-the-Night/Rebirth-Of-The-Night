...
//REPLACEME-Burn.createBuilder("yellow_halite", <primal:ore_salt>, "minecraft:sandstone")
//    .setBurnStages(1)
...
//    .register();
//REPLACEME-Burn.createBuilder("white_halite", <primal:ore_salt>*2, "biomesoplenty:white_sandstone")
//    .setBurnStages(1)
