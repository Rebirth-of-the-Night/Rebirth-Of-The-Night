...
//
<mowziesmobs:frostmaw>.addDrop(<mod_lavacow:sharptooth>,1,4);
<mowziesmobs:frostmaw>.addDrop(<betterwithmods:material:6>,5,9);
//
<mowziesmobs:naga>.addDrop(<mod_lavacow:sharptooth>,2,6);
