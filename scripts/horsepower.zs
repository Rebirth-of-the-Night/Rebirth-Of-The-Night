...
Grindstone.add(<minecraft:red_flower:3>, <minecraft:dye:7>*2, 12);
Grindstone.add(<minecraft:red_flower:6>, <minecraft:dye:7>*2, 12);
Grindstone.add(<minecraft:red_flower:8>, <minecraft:dye:7>*2, 12);
...
Grindstone.add(<minecraft:red_flower:6>, <minecraft:dye:9>*2, 12);
...
Grindstone.add(<minecraft:red_flower:1>, <minecraft:dye:12>*2, 12);
...
Grindstone.add(<minecraft:red_flower:2>, <minecraft:dye:13>*2, 12);
Grindstone.add(<biomesoplenty:flower_0:7>, <minecraft:dye:13>*2, 12);
Grindstone.add(<minecraft:red_flower:5>, <minecraft:dye:14>*2, 12);
...
Grindstone.add(<minecraft:yellow_flower>, <minecraft:dye:11>*2, 12);
Grindstone.add(<biomesoplenty:flower_1:1>, <minecraft:dye:11>*2, 12);
Grindstone.add(<minecraft:red_flower>, <minecraft:dye:1>*2, 12);
Grindstone.add(<minecraft:red_flower:4>, <minecraft:dye:1>*2, 12);
