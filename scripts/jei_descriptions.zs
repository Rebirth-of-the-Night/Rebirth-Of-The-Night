...
JEI.addDescription(<contenttweaker:slime_nesting>, "Lime slimes proliferate in warm grasslands everywhere in the Overworld, and will continue to do so if left unchecked.");
JEI.addDescription(<contenttweaker:slime_nesting>, "Slime nesting is the only block on which slime and watermelon slimes can spawn; getting rid of this block will get rid of them... or they could be used to redirection their population.");
