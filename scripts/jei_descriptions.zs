...
mods.jei.JEI.addDescription(<betterwithmods:steel_axe>,"Provides the best chopping speed and durability, but can only be enchanted in the True Enchanting Table.");
mods.jei.JEI.addDescription(<betterwithmods:steel_shovel>,"Provides the best digging speed and durability, but can only be enchanted in the True Enchanting Table.");
...
/* Defense */
mods.jei.JEI.addDescription(<dungeontactics:fan_block>,"Pushes §lall entities and items§r, extinguishes fires, and blows away dust. Gives a stronger push if there is another fan behind. Because of having a less controlled wind flow than that of a fan elevator it §lcannot make air flow through chutes.");
...
/* Mechanicals and Item Movement */
mods.jei.JEI.addDescription(<quark:rope>, "Smartly tied and intertwined; it will pull blocks up with itself if clicked while sneaking.");
