...
JEI.addDescription(<contenttweaker:slime_nesting>, "Lime slimes proliferate in moderate grasslands in the Overworld in droves when left unchecked. A slime nesting is the only spot on which lime slime and watermelon slimes can appear; getting rid of it block will get rid of them... or it could be used to redirection their population.");
